...
const rawItems = {
  top: [
    ...
    { id: 't2', name: 'Streifen-Shirt', tags: ['schule', 'kino', 'eisdiele', 'sommerfest'], art: capSleeve('#4A7DF4') + [186, 206, 226, 246].map(y => `<path d='M115 ${y} Q150 ${y + 8} 185 ${y}' stroke='#fff' stroke-width='6' fill='none'/>`).join('') },
    { id: 't3', name: 'Strand-Tanktop', tags: ['strand', 'eisdiele'], art: tank('#35C9C0') + `<path d='M116 242 Q133 234 150 242 Q167 250 184 242' stroke='#fff' stroke-width='4' fill='none' stroke-linecap='round'/>` },
    ...
    { id: 't5', name: 'Skater-Hoodie', tags: ['skater', 'schule', 'sommerfest', 'herbst'], art: sleeves('#6BC4A4') + capSleeve('#6BC4A4') + `<path d='M120 170 Q150 198 180 170 Q180 150 150 145 Q120 150 120 170 Z' fill='#4FAE8C'/><rect x='128' y='222' width='44' height='26' rx='11' fill='#4FAE8C'/><path d='M142 182 L142 200 M158 182 L158 200' stroke='#fff' stroke-width='3' stroke-linecap='round'/>` },
    { id: 't6', name: 'Norweger-Pulli', tags: ['winter', 'herbst'], art: sleeves('#D65A5A') + capSleeve('#D65A5A') + `<path d='M113 210 L123 199 L133 210 L143 199 L153 210 L163 199 L173 210 L183 199' stroke='#fff' stroke-width='4' fill='none' stroke-linecap='round'/>` + [[122, 180], [150, 174], [178, 180]].map(p => dot(p[0], p[1], 2.8)).join('') },
    { id: 't7', name: 'Lederjacke', tags: ['rockstar', 'kino'], art: sleeves('#2F2A26') + capSleeve('#2F2A26') + `<path d='M150 158 L150 258' stroke='#6E655C' stroke-width='4'/><path d='M126 166 L136 254 M174 166 L164 254' stroke='#6E655C' stroke-width='3'/><circle cx='138' cy='200' r='3' fill='#C9BFA8'/><circle cx='162' cy='200' r='3' fill='#C9BFA8'/>` },
  ...
  bottom: [
    ...
    { id: 'b2', name: 'Chino', tags: ['schule', 'kino', 'herbst'], art: hip('#C9A87C') + legs('#C9A87C', 546, 32) + `<path d='M133 300 L131 540 M167 300 L169 540' stroke='#B08F63' stroke-width='3'/>` },
    { id: 'b3', name: 'Badeshorts', tags: ['strand', 'eisdiele'], art: hip('#FF8A7A') + `<path d='M133 292 L130 340' stroke='#FF8A7A' stroke-width='35' stroke-linecap='round' fill='none'/><path d='M167 292 L170 340' stroke='#FF8A7A' stroke-width='35' stroke-linecap='round' fill='none'/><path d='M116 336 L146 336 M154 336 L184 336' stroke='#fff' stroke-width='5' stroke-linecap='round'/>` },
    { id: 'b4', name: 'Fussball-Shorts', tags: ['fussball', 'skater', 'sommerfest'], art: hip('#fff') + `<path d='M133 292 L130 346' stroke='#fff' stroke-width='35' stroke-linecap='round' fill='none'/><path d='M167 292 L170 346' stroke='#fff' stroke-width='35' stroke-linecap='round' fill='none'/><path d='M118 300 L118 342 M182 300 L182 342' stroke='#E8433A' stroke-width='5'/>` },
    { id: 'b5', name: 'Baggy-Jeans', tags: ['skater', 'kino', 'eisdiele', 'sommerfest', 'herbst'], art: hip('#5B84C4') + `<path d='M132 292 L126 548' stroke='#5B84C4' stroke-width='40' stroke-linecap='round' fill='none'/><path d='M168 292 L174 548' stroke='#5B84C4' stroke-width='40' stroke-linecap='round' fill='none'/><path d='M112 430 L140 430 M160 430 L188 430' stroke='#9FBCE8' stroke-width='3' stroke-dasharray='6 5'/>` },
  ...
  shoes: [
    ...
    { id: 's5', name: 'Skater-Schuhe', tags: ['skater', 'rockstar', 'kino', 'sommerfest', 'herbst'], art: `<rect x='102' y='546' width='46' height='28' rx='10' fill='#3A3A46'/><rect x='152' y='546' width='46' height='28' rx='10' fill='#3A3A46'/><rect x='102' y='568' width='46' height='10' rx='5' fill='#fff'/><rect x='152' y='568' width='46' height='10' rx='5' fill='#fff'/><path d='M110 556 L128 556' stroke='#fff' stroke-width='3' stroke-linecap='round'/><path d='M160 556 L178 556' stroke='#fff' stroke-width='3' stroke-linecap='round'/>` },
    { id: 's6', name: 'Winterstiefel', tags: ['winter', 'herbst'], art: `<rect x='110' y='514' width='30' height='54' rx='9' fill='#4C6FA8'/><rect x='160' y='514' width='30' height='54' rx='9' fill='#4C6FA8'/><ellipse cx='125' cy='516' rx='18' ry='8' fill='#EAF2FB'/><ellipse cx='175' cy='516' rx='18' ry='8' fill='#EAF2FB'/><rect x='106' y='562' width='38' height='13' rx='6' fill='#3A5684'/><rect x='156' y='562' width='38' height='13' rx='6' fill='#3A5684'/>` },
  ...
  extra: [
    ...
    { id: 'e5', name: 'Skater-Cap', tags: ['skater', 'fussball', 'kino', 'eisdiele', 'sommerfest', 'herbst'], art: `<path d='M104 60 Q106 22 150 20 Q194 22 196 60 Z' fill='#6BC4A4'/><path d='M96 60 Q150 76 204 60 L207 67 Q150 86 93 67 Z' fill='#4FAE8C'/><circle cx='150' cy='22' r='3.5' fill='#fff'/>` },
    { id: 'e6', name: 'Bommelmütze', tags: ['winter', 'herbst'], art: `<path d='M102 66 Q104 18 150 14 Q196 18 198 66 Z' fill='#4C6FA8'/><rect x='100' y='56' width='100' height='17' rx='8' fill='#3A5684'/><circle cx='150' cy='12' r='10' fill='#fff'/>` },
