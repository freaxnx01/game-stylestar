...
const rawItems = {
  top: [
    ...
    { id: 't2', name: 'Glitzer-Top', tags: ['schule', 'festival', 'kino', 'eisdiele', 'sommerfest'], art: capSleeve('#F45FA2') + [[128, 180], [158, 195], [140, 220], [172, 176], [125, 240], [165, 248]].map(p => dot(p[0], p[1], 2.6)).join('') },
    { id: 't3', name: 'Sommer-Top', tags: ['strand', 'eisdiele'], art: tank('#35C9C0') + `<path d='M116 244 Q133 236 150 244 Q167 252 184 244' stroke='#fff' stroke-width='4' fill='none' stroke-linecap='round'/>` },
    { id: 't4', name: 'Boho-Fransentop', tags: ['festival', 'sommerfest'], art: `<path d='M112 164 Q150 152 188 164 L187 240 Q150 252 113 240 Z' fill='#E8933A'/>` + [118, 128, 139, 150, 161, 172, 182].map(x => `<path d='M${x} 240 L${x} 268' stroke='#E8933A' stroke-width='4' stroke-linecap='round'/>`).join('') },
    { id: 't5', name: 'Kuschel-Hoodie', tags: ['pyjama', 'sport', 'herbst'], art: sleeves('#7FD8B8') + capSleeve('#7FD8B8') + `<path d='M120 170 Q150 198 180 170 Q180 150 150 145 Q120 150 120 170 Z' fill='#6BC4A4'/><rect x='128' y='222' width='44' height='26' rx='11' fill='#6BC4A4'/><path d='M142 182 L142 200 M158 182 L158 200' stroke='#fff' stroke-width='3' stroke-linecap='round'/>` },
    { id: 't6', name: 'Schicke Bluse', tags: ['ball', 'schule', 'kino'], art: sleeves('#FFF6E8') + capSleeve('#FFF6E8') + `<path d='M136 154 L150 172 L145 151 Z' fill='#F3E3C8'/><path d='M164 154 L150 172 L155 151 Z' fill='#F3E3C8'/>` + [190, 210, 230].map(y => dot(150, y, 2.6, '#D9B96A')).join('') },
    { id: 't7', name: 'Norweger-Pulli', tags: ['winter', 'herbst'], art: sleeves('#D65A5A') + capSleeve('#D65A5A') + `<path d='M113 210 L123 199 L133 210 L143 199 L153 210 L163 199 L173 210 L183 199' stroke='#fff' stroke-width='4' fill='none' stroke-linecap='round'/>` + [[122, 180], [150, 174], [178, 180], [128, 238], [172, 238]].map(p => dot(p[0], p[1], 2.8)).join('') },
  ...
  bottom: [
    ...
    { id: 'b2', name: 'Jeansrock', tags: ['schule', 'kino', 'eisdiele'], art: `<path d='M118 250 L104 328 Q150 342 196 328 L182 250 Q150 263 118 250 Z' fill='#5B84C4'/><path d='M108 320 Q150 333 192 320' stroke='#9FBCE8' stroke-width='3' stroke-dasharray='6 5' fill='none'/><path d='M122 258 Q130 272 140 274 M178 258 Q170 272 160 274' stroke='#9FBCE8' stroke-width='3' fill='none'/>` },
    { id: 'b3', name: 'Sommer-Shorts', tags: ['strand', 'festival', 'sport', 'eisdiele', 'sommerfest'], art: hip('#FF8A7A') + `<path d='M133 292 L130 332' stroke='#FF8A7A' stroke-width='33' stroke-linecap='round' fill='none'/><path d='M167 292 L170 332' stroke='#FF8A7A' stroke-width='33' stroke-linecap='round' fill='none'/><path d='M118 330 L144 330 M156 330 L182 330' stroke='#fff' stroke-width='4' stroke-linecap='round'/>` },
    { id: 'b4', name: 'Glitzer-Leggings', tags: ['festival', 'schule', 'kpop', 'kino', 'sommerfest', 'herbst'], art: hip('#A05FF4') + legs('#A05FF4', 552, 29) + [sp(132, 360, 5), sp(168, 410, 5), sp(131, 470, 5), sp(169, 510, 5)].join('') },
    ...
    { id: 'b6', name: 'Jogginghose', tags: ['pyjama', 'sport', 'herbst'], art: hip('#9AA3B2') + legs('#9AA3B2', 526, 32) + `<rect x='115' y='522' width='31' height='17' rx='8' fill='#7E8795'/><rect x='154' y='522' width='31' height='17' rx='8' fill='#7E8795'/><path d='M141 300 L138 510 M159 300 L162 510' stroke='#fff' stroke-width='3'/>` },
  ...
  extra: [
    ...
    { id: 'e3', name: 'Sonnenbrille', tags: ['strand', 'festival', 'eisdiele', 'sommerfest'], art: `<rect x='114' y='78' width='32' height='22' rx='10' fill='#3A3A46'/><rect x='154' y='78' width='32' height='22' rx='10' fill='#3A3A46'/><path d='M146 86 L154 86' stroke='#3A3A46' stroke-width='4'/><path d='M114 84 L103 78 M186 84 L197 78' stroke='#3A3A46' stroke-width='4' stroke-linecap='round'/>` },
    { id: 'e4', name: 'Mini-Handtasche', tags: ['schule', 'ball', 'kino'], art: `<path d='M198 304 Q214 282 230 304' stroke='#D6437F' stroke-width='5' fill='none'/><rect x='194' y='302' width='40' height='32' rx='11' fill='#F45FA2'/><circle cx='214' cy='310' r='3.5' fill='#FFE1EF'/>` },
    { id: 'e5', name: 'Blumenkranz', tags: ['festival', 'strand', 'eisdiele', 'sommerfest'], art: [[112, 58], [131, 44], [150, 38], [169, 44], [188, 58]].map(p => fl(p[0], p[1])).join('') },
    { id: 'e6', name: 'Perlenkette', tags: ['ball', 'schule', 'kino', 'herbst'], art: [[126, 168], [134, 177], [143, 182], [150, 184], [157, 182], [166, 177], [174, 168]].map(p => `<circle cx='${p[0]}' cy='${p[1]}' r='4.5' fill='#FDF6EA' stroke='#E0CD9F' stroke-width='1.5'/>`).join('') },
    { id: 'e7', name: 'Bommelmütze', tags: ['winter', 'herbst'], art: `<path d='M102 66 Q104 18 150 14 Q196 18 198 66 Z' fill='#D65A5A'/><rect x='100' y='56' width='100' height='17' rx='8' fill='#B94747'/><circle cx='150' cy='12' r='10' fill='#fff'/>` },
